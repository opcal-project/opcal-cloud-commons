...
class ReactiveWebRequestConfigurationTest {
	...
	private final ApplicationContextRunner contextRunner = new ApplicationContextRunner()
			.withConfiguration(AutoConfigurations.of(ReactiveWebRequestConfiguration.class))
			.withPropertyValues("opcal.cloud.web.reactive.request-id=true");

	@Test
	void enableReactiveRequestId() {
