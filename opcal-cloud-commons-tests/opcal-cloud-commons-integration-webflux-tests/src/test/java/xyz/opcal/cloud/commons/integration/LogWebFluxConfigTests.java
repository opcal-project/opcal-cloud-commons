...
class LogWebFluxConfigTests {

	static final String DISABLE_PATH = "/disable-wx-path";
	static final String DISABLE_MEDIA_TYPES = "image/gif";
	...
	void disablePath() {
		...
		assertEquals(1, logRequestConfig.getDisablePaths().length);
	...
	void disableMediaTypes() {
		...
		assertEquals(1, logRequestConfig.getDisableMediaTypes().length);
